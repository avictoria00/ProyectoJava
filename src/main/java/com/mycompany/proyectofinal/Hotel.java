...
public class Hotel {
 ...
 public class Persona {
    ...
    public Persona(String nombre, String apellido, String id, int acompañantes) {
        this.nombre = nombre;
    ...
    class Minibar {
        ...
        public Minibar(int licores, int agua, int kitsAseo, int gaseosas, int vino, int bata) {
            ...
            for (int i = 0; i < bata; i++) {
                productos.add( new Producto(BATA,precio_bata,"BATA") );
            }
        ...
        public double calcularCosto() {
            return licores * PRECIO_LICOR + agua * PRECIO_AGUA + kitsAseo * PRECIO_KIT_ASEO +
                   gaseosas * PRECIO_GASEOSA + vino * PRECIO_VINO + bata * precio_bata;
        }
    }
    ...
    class Recepcion {
        ...
        private void inicializarHabitaciones() {
            ...
            for (int piso = 2; piso <= 4; piso++) {
                for (int i = 1; i <= 10; i++) {
                    ...
                    String[] cama_sen = {"Una cama doble", "2 camas sencillas"};
            ...
            for (int i = 1; i <= 10; i++) {
                ...
                String[] camas_ejec = { "Una cama tipo queen", "2 camas semidobles" };
            ...
            for (int i = 1; i <= 5; i++) {
                ...
                String[] camas_sut = { "Una cama tipo king", "Una cama tipo king y una semidoble" };
            }
        }
        ...
        public void checkIn(String nombreHuesped, String idHuesped, int numeroHabitacion) {
            Habitacion habitacion = habitaciones.get(numeroHabitacion);
            if (habitacion != null && !habitacion.estaOcupada()) {
                habitacion.ocupar();
                System.out.println("Check-in exitoso para " + nombreHuesped + " en la habitación " + numeroHabitacion);
            } else {
